            ...
            function initAutocomplete() {
				...
				var locations = [
					@foreach ($threads as $userMap)
							['\
								...
								</div>', '{{ $userMap->latitude }}', '{{ $userMap->longitude }}'],
								<?php $counter++;?>
				...
				for (i = 0; i < locations.length; i++) {  
					  marker = new google.maps.Marker({
						...
						marker.setIcon("<?php echo asset('img/assets/icon/pinsmall.png'); ?>");
				...
				<div class="uk-modal-dialog uk-modal-dialog-lightbox uk-modal-dialog-medium">
					...
					<div class="uk-grid">
						...
						<div class="uk-width-2-4 padding-right-35">
							<h2 class="font-green">{{ $user->deskripsi }} Kebun Durian Pak Slamet <?php echo $counter;?> </h2>
							<div style="font-size: 13pt">
								<p>{{ $user->lokasi }}Jalan Delima Raya, Kabupaten Sleman, <br> D.I Yogayakarta {{ $user->provinsi }}</p>
								<div class="uk-grid">
									<div class="uk-width-2-10">
										<img src="<?= asset('img/assets/icon/nature.png') ?>" width="20px" alt="">
									</div>
									<div class="uk-width-8-10 no-padding-left">Durian Monthong{{ $user->jenis }}</div>
								</div>
								<div class="uk-grid margin-top-10">
									<div class="uk-width-2-10">
										<img src="<?= asset('img/assets/icon/money.png') ?>" width="18px" alt="">
									</div>
									<div class="uk-width-8-10 no-padding-left">1 ton per tahun{{ $user->total_yield }}</div>
								</div>
								<div class="uk-grid margin-top-10">
									<div class="uk-width-2-10">
										<img src="<?= asset('img/assets/icon/moneychart.png') ?>" width="16px" alt="">
									</div>
									<div class="uk-width-8-10 no-padding-left">Perkiraan profit 20% per tahun {{ $user->keuntungan }}</div>
								</div>
