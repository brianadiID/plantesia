            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-body">
                  ...
                  <?php
                        $sql = "SELECT * FROM thread where id = $somevar";
                    ...
                    <div>Title</div>
                    <input class="form-control" placeholder="Enter title here" name="title" id="title" value="<?php echo $judul; ?>">
                  </div>
				  ...
				  <div id="infoPanel">
					...
					<b>Current position (Lattitude, Longitude):</b>
					<div id="info"></div>
					...
					<input type = "hidden" value ="<?php echo $somevar;?>" name="id" id ="id">
                  <div class="form-group">
                    <div>Location</div>
                    <input class="form-control" placeholder="Enter location here" name="location" id="location" value="<?php echo $lokasi; ?>">
                    <div>Province</div>
                    <input class="form-control" placeholder="Enter province here" name="province" id="province"value="<?php echo $provinsi; ?>">
                  </div>
                  <div class="col-md-12">
                  <div class="form-group">
                    <nav class="navbar ">
                      <ul class="nav navbar-nav " style="
                        ...
                        <div class="md-col-6" style ="margin-right:20px;">
                          ...
                          <input class="form-control" placeholder="Plantation Type" name="plantation" id="plantation" value="<?php echo $tipe;?>">
                        </div>
                        </li>
                        <li>
                        <div class="md-col-6" style ="margin-right:20px;">
                          <div>Yield</div>
                          <input class="form-control" placeholder="Yield per year" name="yield" id="yield" value="<?php echo $yield; ?>">
                        </div>
                        </li>
                        ...
                        <div class="md-col-6" style ="margin-right:20px;">
                          ...
                          <input class="form-control" placeholder="Profit per year" name="profit" id="profit" value="<?php echo $profit; ?>">
                          </div>
                        </li>
						<li>
                        <div class="md-col-6" style ="margin-right:20px;">
                          <div>Lattitude</div>
                          <input class="form-control" placeholder="Koordinat Lattitude" name="lattitude" id="lattitude" value="<?php echo $lat; ?>">
                        </div>
                        </li>
						<li>
                        <div class="md-col-6" style ="margin-right:20px;">
                          <div>Longitude</div>
                          <input class="form-control" placeholder="Koordinat Longitude" name="longitude" id="longitude" value="<?php echo $lng; ?>">
                        </div>
                        </li>
                      </ul>
                      </nav>
	...
	function initialize() {
	  var latLng = new google.maps.LatLng(
	  	<?php if($lat != NULL && $lng != NULL){
	  		echo $lat;?>,<?php echo $lng;
	  	}
	  	else{
	  		echo -6.175;?>,<?php echo 106.826;
	  	}?>
	  	);
